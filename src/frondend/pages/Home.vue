  ...
  <div>
    ...
    <div class="page-section">
      <div class="container">
        ...
        <div class="wow fadeInUp" id="doctorSlideshow">
          <carousel
            :nav="false"
            :dots="false"
            :responsive="{
          ...
          >
            ...
            <template slot="prev">
              <span
                class="prev btn btn-primary btn-sm"
                style="
                  top: 540px !important;
                  float: right;
                  position: absolute;
            ...
            <template slot="next">
              <span
                class="next btn btn-primary btn-sm"
                style="
                  top: 560px !important;
                  float: right;
                  margin-right: 60px;
      ...
      <div class="container">
        ...
        <div class="row mt-5">
          ...
          <div class="col-12 text-center mt-4 wow zoomIn">
            <router-link to="/news"
              ><a href="" class="btn btn-primary">Read More</a></router-link
            >
          </div>
        </div>
      </div>
